...
class RecApplicationService_4 {
    ...
    def bulkDownloadDocuments(hm, request, response, data) {
        try {
            ...
            println("Error in bulkDownloadDocuments: ${e.message}")
            e.printStackTrace()
    ...
    def bulkApproveApplications(hm, request, data) {
        try {
            ...
            println("Error in bulkApproveApplications: ${e.message}")
            e.printStackTrace()
            hm.msg = "Error in bulk approval: ${e.message}"
            hm.flag = false
        }
    }
    ...
    def bulkRejectApplications(hm, request, data) {
        try {
            ...
            println("Error in bulkRejectApplications: ${e.message}")
            e.printStackTrace()
            hm.msg = "Error in bulk rejection: ${e.message}"
            hm.flag = false
        }
    }
    ...
    def exportApplications(hm, request, response, data) {
        try {
            ...
            println("Error in exportApplications: ${e.message}")
            e.printStackTrace()
            hm.msg = "Error exporting applications: ${e.message}"
            hm.flag = false
        }
    }
}
