    ...
    */
    def getRecDocumentTypeList(hm, request) {
        try {
            ...
            println("Error in getRecDocumentTypeList: ${e.message}")
    ...
    */
    def saveRecDocumentType(hm, request, data) {
        try {
            ...
            println("Error in saveRecDocumentType: ${e.message}")
    ...
    */
    def editRecDocumentType(hm, request, data) {
        try {
            ...
            println("Error in editRecDocumentType: ${e.message}")
    ...
    */
    def deleteRecDocumentType(hm, request, data) {
        try {
            ...
            println("Error in deleteRecDocumentType: ${e.message}")
    ...
    */
    def toggleDocumentTypeActive(hm, request, data) {
        try {
            ...
            println("Error in toggleDocumentTypeActive: ${e.message}")
    ...
    def getRecDocumentList(hm, request) {
        try {
            ...
            println("Error in getRecDocumentList: ${e.message}")
    ...
    def getApplicantDocuments(hm, request, data) {
        try {
            ...
            println("Error in getApplicantDocuments: ${e.message}")
    ...
    def getDocumentStatistics(hm, request) {
        try {
            ...
            println("Error in getDocumentStatistics: ${e.message}")
