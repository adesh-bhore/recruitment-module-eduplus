...
class RecInterviewScheduleService {
    ...
    def getRecBranchList(hm, request) {
        try {
            ...
            log.error("Error in getRecBranchList: ${e.message}", e)
    ...
    def saveRecBranch(hm, request, data) {
        try {
            ...
            log.error("Error in saveRecBranch: ${e.message}", e)
    ...
    def editRecBranch(hm, request, data) {
        try {
            ...
            log.error("Error in editRecBranch: ${e.message}", e)
    ...
    def deleteRecBranch(hm, request, data) {
        try {
            ...
            log.error("Error in deleteRecBranch: ${e.message}", e)
    ...
    def toggleBranchActive(hm, request, data) {
        try {
            ...
            log.error("Error in toggleBranchActive: ${e.message}", e)
